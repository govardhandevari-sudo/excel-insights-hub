...
const columns = [
  ...
  { key: "w52", label: "W52", align: "right" as const, render: (v: number) => v ? v.toLocaleString() : "" },
  { key: "w51", label: "W51", align: "right" as const, render: (v: number) => v ? v.toLocaleString() : "" },
  { key: "w50", label: "W50", align: "right" as const, render: (v: number) => v ? v.toLocaleString() : "" },
  { key: "mtd", label: "Dec MTD", align: "right" as const, render: (v: number) => v ? <span className="font-semibold">{v.toLocaleString()}</span> : "" },
  { key: "nov", label: "Nov '25", align: "right" as const, render: (v: number) => v ? v.toLocaleString() : "" },
  { key: "oct", label: "Oct '25", align: "right" as const, render: (v: number) => v ? v.toLocaleString() : "" },
];
      ...
      <div className="space-y-6 animate-fade-in">
        ...
        <Card className="shadow-card">
          <CardHeader className="pb-2">
            <CardTitle className="font-heading text-lg">Top Departments by Volume</CardTitle>
          </CardHeader>
          <CardContent>
